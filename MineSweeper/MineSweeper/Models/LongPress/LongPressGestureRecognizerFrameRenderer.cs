...
namespace MineSweeper.Models.LongPress
{
    /// <summary>
    /// Custom <see cref="Behavior"/> not created by me and I'm not sure how it works
    /// </summary>
    public class LongPressBehavior : Behavior<ImageButton>
    {
        ...
        public LongPressBehavior(int x, int y, int duration) : this(x, y)
        {
            _duration = duration;
        }
